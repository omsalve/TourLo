...
// Load ScrollStack on the client to avoid SSR scroll/observer issues
const ScrollStack = dynamic(
  () => import("./components/lightswind/scroll-stack"),
  { ssr: false }
);
...
export default function Hero() {
  ...
  <div className="relative w-full h-full bg-[radial-gradient(circle,rgba(255,255,255,0.35)_1px,transparent_1px)] [background-size:20px_20px] overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <section className="relative w-full min-h-screen text-white flex flex-col items-center justify-center px-6">
          ...
          <motion.a
            ...
            className="absolute top-6 right-6 px-5 py-2 sm:px-6 sm:py-3 rounded-lg bg-transparent text-white/70 hover:text-white transition cursor-pointer"
          >
            CONTACT US
          </motion.a>
          ...
          >
            <motion.h1
              className={`${montserrat.className} font-extrabold leading-tight text-3xl sm:text-[clamp(2rem,6vw,4rem)]`}
              variants={fadeInUp}
            >
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-8 w-full">
                      ...
                      <div className="flex-1 text-left">
                        ...
                        <p className="text-gray-300 mb-6">
                          ...
                          comprehensive 3D 360 VR tours. Delivering an intuitive
                          and immersive journey with our advanced clickable
                          hotspots allow for seamless exploration and discovery
                          of rich content within each 3D scene.
                        </p>
                  ...
                  content: (
                    <div className="flex flex-col md:flex-row items-center gap-8 w-full">
                      ...
                      <div className="flex-1 text-left">
                        ...
                        <p className="text-gray-300 mb-6">
                          Quickly view nearby schools, parks, shopping, and
                          transport links. Our digitised mapping provides a
                          clear, interactive snapshot of the neighbourhood,
                          enhancing decision-making with real-time accessibility
                          insights.
                        </p>
                        <button className="px-6 py-3 rounded-full bg-white text-black font-semibold hover:scale-105 transition-transform">
                          Know More
                  ...
                  content: (
                    <div className="flex flex-col md:flex-row items-center gap-8 w-full">
                      <div className="flex-1 text-left">
                        ...
                        <p className="text-gray-300 mb-6">
                          Bring your vision to life with hyperreal customisation.
                          Alter materials, furniture, and décor in a highly
                          immersive 3D space, allowing you to visualise your
                          dream home down to the finest details.
                        </p>
                        <button className="px-6 py-3 rounded-full bg-white text-black font-semibold hover:scale-105 transition-transform">
                          Know More
                        </button>
                  ...
                  content: (
                    <div className="flex flex-col md:flex-row items-center gap-8 w-full">
                      <div className="flex-1 text-left">
                        ...
                        <p className="text-gray-300 mb-6">
                          Experience an immersive 3D walkthrough of property
                          from layouts, room details and balcony views. Explore
                          every corner, allowing potential buyers to visualise
                          themselves in the space and make confident decisions.
                        </p>
                        <button className="px-6 py-3 rounded-full bg-white text-black font-semibold hover:scale-105 transition-transform">
                          Know More
                        </button>
                  ...
                  content: (
                    <div className="flex flex-col md:flex-row items-center gap-8 w-full">
                      <div className="flex-1 text-left">
                        ...
                        <p className="text-gray-300 mb-6">
                          Search and filter available units effortlessly with
                          customisable options tailored for your project.
                          Real-time inventory integration keeps listings
                          updated, enhancing the buyer’s experience and
